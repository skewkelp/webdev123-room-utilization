<div class="sidebar flex-column flex-shrink-0" id="sidebar">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
        ...
        <div class="d-flex side-nav-title">
            <li class="side-nav-title staff admin">Personal</li>
        </div>
        ...
        <li class="nav-item staff">
            <a href="faculty-class-list" id="faculty-classlist-link" class="nav-link">
                <i class="bi schedule-icon">
                    <img src="../img/sidebar-icon/faculty-class-list-icon.svg" alt="" width="22.5px" height="22.5px">
                </i>
                <span class="sidebar-button-text ms-2">Class List</span>
            </a>
        </li>
    </ul>
</div>