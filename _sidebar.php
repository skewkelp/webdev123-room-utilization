<div class="sidebar flex-column flex-shrink-0" id="sidebar">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
        ...
        <li class="nav-item">
            <a href="room-list.php" id="roomlist-link" class="nav-link">
        ...
        <li class="nav-item">
            <a href="room-status.php" id="roomstatus-link" class="nav-link">
                <i class="bi status-icon">
        ...
        <li class="nav-item">
            <a href="room-schedule.php" id="products-link" class="nav-link">
